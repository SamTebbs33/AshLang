...
TokenStatement::TokenStatement() : TokenPreParseable(){
...
TokenDeclaration::TokenDeclaration(TokenIdentifier i, ModifiersInt m) : id(i), mods(m), TokenStatement(){

}

TokenDeclaration::TokenDeclaration(TokenIdentifier i) : id(i), TokenStatement(){
...
TokenBlock::TokenBlock() : TokenPreParseable(){
...
void TokenBlock::preParse(){
	foreach(it, stmts) if(*it) (*it)->preParse();
}
